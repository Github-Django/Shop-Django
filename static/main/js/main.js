...
$('[data-countdown]').each(function () {
	...
	$this.countdown(finalDate, function (event) {
		$this.html(event.strftime('<div class="time-count day"><span>%D</span>روز</div><div class="time-count hour"><span>%H</span>ساعت</div><div class="time-count min"><span>%M</span>دقیقه</div><div class="time-count sec"><span>%S</span>ثاتیه</div>'));
	});
});
